	...
	<div>
		<form method="post">
			<table>
				...
				<tr>
					<th>번호</th>
					<td><input type="hidden" name="key" value="-1"/>신규(Insert)</td>
				</tr>
				<tr>
					<th>제목</th>
				...
				<tr>
					<th>원글</th>
					<td><input type="hidden" name="rootid" value="-1"/>신규(Insert)</td>
				</tr>
				<tr>
					<th>댓글수준</th>
					<td><input type="text" name="relevel" value="0" readonly/></td>
				</tr>
				<tr>
					<th>댓글순서</th>
					<td><input type="text" name="recnt" value="0" readonly/></td>
				</tr>
			</table>
			<span>
				<input type='button' value='취소' onclick="location.href='index.jsp'"/>
				<input type='button' value='신규' onclick="checkNull()"/>
			</span>
		</form>
	</div>
</body>
